...
<head>
    ...
    <meta charset="utf-8">
    <base href="/leitner_system/cabinet/cards/">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">КАРТОЧКИ</h1>
                    ...
                    <div class="row">
                         ...
                         <div class="col-lg-12 mb-3">
                            <div class="card shadow mb-3">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Выбрать коллекцию</h6>

                                </div>
                                <div class="card-body">
                                   <form action="getCardsFromCollection" method="POST">
                                    <div class="form-group">
                                    <select name="col_id" class="form-control" id="col_id">
                        <?php
                     ...
                     echo "<option value = ".$value['id'].">".$value['name']."</option>";
                        ...
                        ?>
                                 ...
                                 <button type="submit" class="btn-primary btn">Показать</button>
                                </form>
                 ...
                 <div class="page-wrapper" data-ng-app="cards" data-ng-controller="cardsController">
                    <!-- Content Row -->
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Карточки</h6>

                                </div>
                                <div class="col-lg-12" data-ng-view>
                                ...
                                <div class="card-body">
                                    ...
                                    <table class="table table-bordered table-hover table-striped">
                                        ...
                                        <tbody>
                                            ...
                                            <?php 
                                                foreach ($pageData['cards'] as $key => $value) { ?>
                                                  
                                                <tr>
                                                    <td ><?php echo $value['id'];?></td>
                                                  
                                                    <td><a data-ng-click="getInfoByCardId(<?php echo $value['id'];?>)" href="<?php echo $value['id'];?>"><?php echo $value['front_side'];?></a></td>
                                                    <td><?php echo $value['back_side'];?></td>
