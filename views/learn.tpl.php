<!DOCTYPE html>
<html lang="ru" data-ng-app="learn">

<head>

    <meta charset="utf-8">
    <base href="/leitner_system/cabinet/learn/">
...
<body id="page-top" data-ng-controller="learningController">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Обучение</h1>
                        
                    </div>

                
                 <div class="page-wrapper" data-ng-app="learn" data-ng-controller="learningController">
                    <!-- Content Row -->
                    <div class="row">
                       ...
                       foreach ($pageData['collections'] as $key=>$value) { ?>
                            ...
                            <div class="card shadow mb-4" >
                                <div class="card-header py-3" data-ng-click="learn(<?php echo $value['id']?>)" type="button">
                                    <input type="text" hidden="true" value="<?php echo $value['id'];?>">
    ...
    <script src="../../js/ang_learning.js"></script>
