...
<head>
    ...
    <meta charset="utf-8">
    <base href="/leitner_system/cabinet/profile/">
            ...
            <div id="content">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">
                                    ...
                                    <?php echo $pageData['userInfo']['fullName'];?>
                                </span>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">МОЙ ПРОФИЛЬ</h1>                        
                    </div>

                    <!-- Content Row -->
               
                                   
                 <div class="page-wrapper" data-ng-controller="profileController">
                    <!-- Content Row -->
                    <div class="row">
                            ...
                            <form class="form-horizontal" method="post" data-ng-submit="saveProfileData()">
                                ...
                                <fieldset>
                                    ...
                                    <div class="form-group"> 
                                        ...
                                        <div class="col-md-4">
                                            <input  class="form-control input-md" required="true" type="email" id="email" value="<?php echo $pageData['userInfo']['email'];?>">
                                        </div>
                                    </div>
                               ...
                               <input type="hidden" name="userId" id="userId" value="<?php echo $pageData['userInfo']['id'];?>">
                                <fieldset>
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <input class="form-control input-md"  data-ng-model="newpass" required="true"  type="password"  id="newpass" value="" >
                                        </div>
                                    </div>
